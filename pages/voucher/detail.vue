	...
	<view class="container">
		...
		<navigator url="/pages/address/address?source=1" class="address-section">
			<view class="order-content">
				...
				<view class="cen">
					<view class="top">
						<text class="name">摸鱼划水吧</text>
						<text class="mobile">{{constance.phone_number}}</text>
					</view>
					<text class="address">{{constance.location}}</text>
				</view>
...
<!-- 			<view class="g-header b-b">
			<image class="logo" :src="currentProduct.image1"></image>
		...
		<view class="ui-all">
			...
			<view class="ui-list right">
				<text>有效期:</text>
				<text>{{currentGoods.validity_period_start}}~{{currentGoods.validity_period_end}}</text>
			</view>
			<view class="ui-list right">
				<text>详情:</text>
				<textarea>{{currentGoods.description}}</textarea>
			</view>
		</view>
...
<!-- 			<view class="yt-list-cell b-b">
			...
			<view class="yt-list-cell b-b" v-if="currentGoods.can_use_balance > 0">
...
<script>
	...
	export default {
		...
		onLoad(option) {
			...
			this.useAccountBalance = this.currentGoods.can_use_balance > 0;
		},
		methods: {
